...
class PhoneBook:
    ...
    def validate_phone_number(self, phone_number: str) -> Union[str, bool]:
        ...
        if not phone_number.isdigit() or not re.match(r"^09\d{9}$", phone_number):
            return "User's phone number must be 11 digits and only contain digits!"
        return True
    ...
    def edit_name(self, name: str, new_name: str) -> str:
        if self.validate_name(new_name) is True:
    ...
    def edit_phone_number(self, name: str, new_phone_number: str) -> str:
        if self.validate_phone_number(new_phone_number) is True:
    ...
    def edit_email(self, name: str, new_email: str) -> str:
        if self.validate_email(new_email) is True:
